...
function Mnbaa_Watermark_create_watermark() {
    register_post_type('watermark', array(
        'labels' => array(
            ...
            'edit_item' => __('Modifica Watermark', 'mnbaa_watermark'),
            'new_item' => __('Nuovo Watermark', 'mnbaa_watermark'),
            'all_items' => __('Tutti Watermarks', 'mnbaa_watermark'),
            'view_item' => __('Guarda Watermark', 'mnbaa_watermark'),
...
function Mnbaa_Watermark_add_meta_box() {
    ...
    add_meta_box('custom_meta_box', __('Dimensione Immagine', 'mnbaa_watermark'), 'font_setting_metabox_callback', 'watermark', 'normal');
	add_meta_box('custom_meta_box4', __('Inserisci il logo Tilllate', 'mnbaa_watermark'), 'upload_image_metabox_callback', 'watermark', 'normal');
	add_meta_box('custom_meta_box5', __('Inserisci il logo Locale', 'mnbaa_watermark'), 'upload_image_metabox_callback_1', 'watermark', 'normal');
}
...
function upload_image_metabox_callback_1($post){
	include (plugin_dir_path(__FILE__) . '../views/img_upload.php');
}
